<template>
  <div class="space-y-2">
    ...
    <ul v-else>
      ...
      <li v-if="!dueSoonLimited.length" class="py-2 text-sm text-gray-500">Nessuna scadenza nei prossimi 10 giorni</li>
    </ul>
  </div>
</template>
...
const props = defineProps({
  limit: { type: Number, default: 8 } // 👈 nuovo
})
...
// applico il limite passato da prop
const dueSoonLimited = computed(() => dueSoon.value.slice(0, props.limit))
